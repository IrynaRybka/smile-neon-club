...
const priceList = [
  ...
  { name: "Неонова дискотека з бульбашками 30хв", price: "5900 грн" },
  { name: "Блиск тату", price: "530 грн/10 дітей" },
  { name: "Кольоровий пісок А4/А5", price: "1240 / 1140 грн/10 дітей" },
  { name: "Піньята", price: "від 650 грн" },
  { name: "Виготовлення бомбочок для ванни", price: "2600 грн/10 дітей" },
  { name: "Розпис футболок/рюкзаків/кепок", price: "3700 грн/10 дітей" },
  { name: "Розпис сумок", price: "3200 грн/10 дітей" },
  { name: "Ебру", price: "2700 грн/10 дітей" },
  { name: "Свічки гелеві фігурні", price: "3700 грн/10 дітей" },
  { name: "Свічки вощина по 2 шт", price: "2800 грн/10 дітей" },
  { name: "Таба лапки (пропозиція діє в теплий сезон)", price: "3200 грн/10 дітей" },
  { name: "Слайми", price: "2500 грн/10 дітей" },
  { name: "Парфуми", price: "3500 грн/10 дітей" },
  { name: "Морозиво з фетру", price: "2900 грн/10 дітей" },
  { name: "Чарівна паличка Гаррі Поттера", price: "2600 грн/10 дітей" },
  { name: "Миловаріння", price: "3500 грн/10 дітей" },
