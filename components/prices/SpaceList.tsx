...
const priceList = [
  { name: "Аніматор (1 година/1 герой)", price: "від 3500 грн + трансфер від 600 грн" },
  { name: "Неонова дискотека з бульбашками 30хв", price: "620 грн" },
  { name: "Блиск тату", price: "580 грн/до 10 дітей" },
  { name: "Кольоровий пісок А4/А5", price: "1850 / 1550 грн/до 10 дітей" },
  ...
  { name: "Ебру - магія малюнку на воді", price: "2900 грн/до 10 дітей" },
  ...
  return (
    <section className="py-8 md:py-12 pb-20">
      <h2 className="text-center text-xl md:text-2xl font-bold tracking-wider text-[#a476ff] uppercase mb-8">
        ДОДАТКОВІ ПОСЛУГИ ТА МАЙСТЕР-КЛАСИ
      </h2>
